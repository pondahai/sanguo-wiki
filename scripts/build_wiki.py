# -*- coding: utf-8 -*-
"""三國演義 → Obsidian wiki vault
讀 data/sanguo_raw.txt,切 120 回、自動加人名 [[連結]]、生成人物頁與索引。
"""
import re
import sys
...
def main():
    ...
    assert len(chapters) == 120, "應為 120 回"
    ...
    for num, title, body in chapters:
        ...
        next_link = f"[[第{num+1:03d}回 {chapters[num][1].replace('  ', ' ')}|下一回 →]]" if num < 120 else ""
